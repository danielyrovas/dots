return function(client, bufnr)
  ...
  if client.supports_method "textDocument/formatting" then
    ...
    if vim.b.autoformat_enabled == nil then vim.b.autoformat_enabled = vim.g.autoformat_enabled end
    add_buffer_autocmd("lsp_auto_format", bufnr, {
      ...
      callback = function()
        ...
        if vim.b.autoformat_enabled then vim.lsp.buf.format { bufnr = bufnr } end
      end,
    })
    maps.n["<leader>uf"] = {
