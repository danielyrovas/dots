# Generated by Powerlevel10k configuration wizard on 2023-08-23 at 11:40 AEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # rtx                    # asdf version manager (https://github.com/asdf-vm/asdf)
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='󱑎 %D{%H:%M:%S}'
